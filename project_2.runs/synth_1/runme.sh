...
HD_PWD='C:/Users/vilpp/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rbg_selector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rbg_selector.tcl
