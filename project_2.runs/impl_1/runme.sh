...
HD_PWD='C:/Users/vilpp/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rbg_selector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rbg_selector.tcl -notrace
