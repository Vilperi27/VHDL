...
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS33 } [get_ports { n_Reset }]; IO_L4P_T0_35 Sch=n_Reset
set_property -dict { PACKAGE_PIN D20   IOSTANDARD LVCMOS33 } [get_ports { input }];  IO_L4N_T0_35 Sch=input
